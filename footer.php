...
<!--Портфолио компании-->
<?php include "./blocks/img-gallery.php" ?>
<!--С кем мы работаем-->
    ...
    <div class="subfooter">
        <div class="container">
            ...
            <div class="row flex-footer">
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 subfooter__info">
                ...
                <div class="col-lg-5 col-md-5 adress">
                    ...
                    <p><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@alp-spb.ru">info@alp-spb.ru</a></p>
